...
static inline int edl_init_screen(EDL_SCREEN *screen, const u32 res_x, const u32 res_y, u32 color) {
...
static inline int edl_dalloc_screen(EDL_SCREEN *screen) {
...
// Show EDL_SCREEN
static inline int edl_show_screen(const EDL_SCREEN *screen) {
...
static inline int edl_clear_screen(EDL_SCREEN *screen, u32 color) {
